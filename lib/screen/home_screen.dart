...
class _HomeScreenState extends State<HomeScreen>
  ...
  */
  ...
  var cards = [
    {'num': 0, 'kind': 'A', 'status': FabFloatOffsetY},
    {'num': 0, 'kind': 'A', 'status': FabFloatOffsetY},
    {'num': 0, 'kind': 'A', 'status': FabFloatOffsetY},
    {'num': 0, 'kind': 'A', 'status': FabFloatOffsetY},
    {'num': 0, 'kind': 'A', 'status': true},
  ];
      ...
      _timer = Timer.periodic(Duration(milliseconds: 1000), (timer) {
        setState(() {
          ...
          if (_time > 60)
            ...
            _timeProgress = double.parse((_time / 60).toStringAsPrecision(8));
  ...
  void recordPoints(pt) async {
    final response = await http.post(
      'https://mygospel.net/quiz/card/ajax_card_record.php',
      body: jsonEncode(
            ...
            child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child:
                        ...
                        textColor:
                            _isPlaying ? Colors.white70 : Colors.white, // 글씨 색상
                        color: _isPlaying
                            ? Colors.black26
                            : Colors.orange, // 배경 색상
                        onPressed: () {
              ...
              Container(
                ...
                child:
                  ...
                  child: Text('카드변경'),
                  textColor:
                      _isPlaying ? Colors.white : Colors.white60, // 글씨 색상
